...
public enum AiProvider {
    ...
    HY3(
            "hy3", R.string.ai_provider_hy3, R.color.ai_brand_hy3, "hy",
    ...
    CHATGPT(
            "chatgpt", R.string.ai_provider_chatgpt, R.color.ai_brand_chatgpt, "openai",
            "https://api.openai.com/v1", "gpt-4o-mini"),
    GEMINI(
            "gemini", R.string.ai_provider_gemini, R.color.ai_brand_gemini, "Google",
            "https://generativelanguage.googleapis.com/v1beta/openai", "gemini-2.5-flash"),
    CLAUDE(
            "claude", R.string.ai_provider_claude, R.color.ai_brand_claude, "anthropic",
